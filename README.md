...
```
* * * * * ubuntu bash /home/ubuntu/apps/fy18/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|fy18|tweet|`location`||
|fy18|facebook|`location`||
|fy18|email|`location`||
|fy18|new-comment||
|fy18|open-share-discuss||
|fy18|close-share-discuss||
|fy18|summary-copied||
|fy18|featured-tweet-action|`action`|
|fy18|featured-facebook-action|`action`|
